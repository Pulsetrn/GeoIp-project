...
async function getData() {
    ...
    if (validateIp(inputData)) {
        const response = await fetch(`https://geo.ipify.org/api/v2/country,city?apiKey=at_hctYzT6UtwqXjbNkZPgsO4HIXWteR&ipAddress=${inputData}`);
...
//# sourceMappingURL=index.f673b030.js.map
